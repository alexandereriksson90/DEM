...
public class TransparentImage extends JPanel {
	...
	protected void paintComponent(Graphics g){
		...
		Image resizeB = resize(arcgridImage,arcgridImage.getWidth()*2,arcgridImage.getHeight()*2);
		g.drawImage(resizeB,0,0,null);
		Graphics2D g2d = (Graphics2D) g;
		Dimension scaled = getScaled(new Dimension(imageWidth,imageHeight),new Dimension(arcgridImage.getWidth()*2,arcgridImage.getHeight()*2));
	...
	public BufferedImage createPicture(){
		...
		image = (BufferedImage) createImage(matrix.getRows(),matrix.getColumns());
